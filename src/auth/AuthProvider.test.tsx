...
describe("AuthProvider", () => {
    it("provides an unauthenticated state when keycloak has not authenticated", () => {
        renderAuthProvider();
    ...
    it("synchronizes auth state when keycloak reports auth success", () => {
        renderAuthProvider();
    ...
    it("clears the token and synchronizes auth state when token refresh fails", () => {
        keycloakMock.authenticated = true;
        keycloakMock.roles.add("USER");
